...
Jiyo (JIYO) is an open-source Proof-of-Work digital cryptocurrency for
...
Unpack the files into a directory and run 'usr/bin/jiyo-qt.exe'.

Jiyo Core is the original Jiyo client and it builds the backbone of the
network. However, it downloads and stores the entire history of Jiyo
