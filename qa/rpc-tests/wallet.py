...
#   c) node1 mines 32 blocks, so now node 0 has 60001 JIYO, node 1 has 4250 JIYO, node2 has none.
#   d) node0 sends 601 JIYO to node2, in two transactions (301 JIYO, then 300 JIYO).
