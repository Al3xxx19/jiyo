...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zjiyoTracker->HasMintTx(hash))) {
            //zJIYO stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZJIYO;
...
bool IsZJIYOType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZJIYO:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZJIYO || type == TransactionRecord::MNReward) {
