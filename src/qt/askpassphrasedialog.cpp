                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zJIYO || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending JIYO because you wouldn't check it anyway.
    if (context == Context::Send_JIYO || context == Context::Send_zJIYO) {
