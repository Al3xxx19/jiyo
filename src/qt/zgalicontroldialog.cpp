...
std::set<std::string> ZJiyoControlDialog::setSelectedMints;
std::set<CMintMeta> ZJiyoControlDialog::setMints;

bool CZJiyoControlWidgetItem::operator<(const QTreeWidgetItem &other) const {
    int column = treeWidget()->sortColumn();
    if (column == ZJiyoControlDialog::COLUMN_DENOMINATION || column == ZJiyoControlDialog::COLUMN_VERSION || column == ZJiyoControlDialog::COLUMN_CONFIRMATIONS)
...
void ZJiyoControlDialog::updateList()
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        CZJiyoControlWidgetItem* itemDenom(new CZJiyoControlWidgetItem);
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        CZJiyoControlWidgetItem *itemMint = new CZJiyoControlWidgetItem(ui->treeWidget->topLevelItem(mapDenomPosition.at(denom)));
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "The zJIYO seed used to mint this zJIYO is not the same as currently hold in the wallet";
            else
...
void ZJiyoControlDialog::updateLabels()
{
    ...
    privacyDialog->setZJiyoControlLabels(nAmount, setSelectedMints.size());
}

std::vector<CMintMeta> ZJiyoControlDialog::GetSelectedMints()
{
