                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzJIYOPathCustom = GetArg("-zjiyobackuppath", "");
    ...
    if(!strzJIYOPathCustom.empty()) {
        ui->wallet_customzjiyobackuppath->setText(QString::fromStdString(strzJIYOPathCustom));
        ui->wallet_customzjiyobackuppath_label->setVisible(true);
        ui->wallet_customzjiyobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzJIYOPathCustom.empty()) && nCustomBackupThreshold > 0) {
