...
static void NotifyzJIYOReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzJIYOReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzJIYOReset.connect(boost::bind(NotifyzJIYOReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzJIYOReset.disconnect(boost::bind(NotifyzJIYOReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zjiyoTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus, fWrongSeed);
}
