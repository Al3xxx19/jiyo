...
public:
    ...
    bool WriteZJIYOSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZJIYOSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZJIYOSeed_deprecated(uint256& seed);
    bool EraseZJIYOSeed();
    bool EraseZJIYOSeed_deprecated();

    bool WriteZJIYOCount(const uint32_t& nCount);
    bool ReadZJIYOCount(uint32_t& nCount);
