...
#ifndef JIYO_ZJIYOWALLET_H
#define JIYO_ZJIYOWALLET_H
...
public:
    CzJIYOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZJIYO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZJIYO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
