...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"jiyo", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"jiyo", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"jiyo", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        ...
        {"zerocoin", "getzjiyoseed", &getzjiyoseed, false, false, true},
        {"zerocoin", "setzjiyoseed", &setzjiyoseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzjiyo", &searchdzjiyo, false, false, true},
        {"zerocoin", "dzjiyostate", &dzjiyostate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:35108/\n";
}
