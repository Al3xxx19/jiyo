...
extern UniValue setzjiyoseed(const UniValue& params, bool fHelp);
extern UniValue getzjiyoseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzjiyo(const UniValue& params, bool fHelp);
extern UniValue dzjiyostate(const UniValue& params, bool fHelp);
