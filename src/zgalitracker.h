...
#ifndef JIYO_ZJIYOTRACKER_H
#define JIYO_ZJIYOTRACKER_H
...
public:
    CzJIYOTracker(std::string strWalletFile);
    ~CzJIYOTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzJIYOWallet* zJIYOWallet = NULL);
